...
O Shinobilson Bot é um bot de música para Discord com integração exclusiva ao YouTube. Ele oferece os comandos slash `/play`, `/search`, `/queue`, `/pause`, `/skip` e `/stop`, mantendo uma fila independente por servidor.
